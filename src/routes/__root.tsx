  ...
  head: () => ({
    meta: [
      ...
      { title: "Kinetix Guest — AI Productivity Workspace" },
      {
        name: "description",
        content:
          "Draft emails, summarize meetings and plan your work with AI. No account, no login.",
      },
      { property: "og:title", content: "Kinetix Guest — AI Productivity Workspace" },
      {
        property: "og:description",
        content: "AI email drafting, meeting summaries and planning — guest mode only.",
      },
